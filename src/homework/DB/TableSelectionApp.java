...
public class TableSelectionApp extends JFrame{
	JPanel p_west;
	JTextField t_ip; //접속하고자 하는 db서버의 아이피 주소
	Choice choice;
	...
	public TableSelectionApp() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				System.out.println("당신이 선택한 row는"+row+"당신이 선택한 col는"+col);
	...
	public void load() {
		...
		//System.out.println(t_ip.getText()+"서버의"+item +"테이블원해?");
